"""
Django settings for an_app_50 project.
...
WSGI_APPLICATION = 'an_app_50.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "an_app_50 API",
    "DESCRIPTION": "API documentation for an_app_50 App",
    "VERSION": "v1",
}
